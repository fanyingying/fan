...
const state = {
  ...
  gitHubUser: {
    login:'fanyingying',
    avatar_url:'https://avatars3.githubusercontent.com/u/11494255?s=460&v=4'
  },  // 这个不要修改，这个不要修改，这个不要修改。
  gitHubUsername: 'fanyingying',  // 修改成你自己的 GitHub 账号
  copyright: '2018 - 2019',  // 修改成你自己的
  recordNumber: 'null',  // 修改成你自己的备案编号，如果没有备案的话就设置为 null
  repo: 'fanyingying/myblog',  // 记录 Issue 的仓库的全名「用户名/仓库名」
  ...
  thirdPartySite: [  // 配置你想在左上角展示的第三方站点信息
    {
      ...
      url: 'https://github.com/fanyingying'  // 第三方站点的 url
    }
